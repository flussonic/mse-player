...
export default class MSEPlayer {
  ...
  constructor(media, urlStream, opts = {}) {
    ...
    console.log('this.opts0', this.opts)

    if (this.opts.connectionRetries) {
      console.log(this.opts.connectionRetries);
    }
    ...
    console.log(
      ...
      this.opts.connectionRetries || DEFAULT_CONNECTIONS_RETRIES
    )

    this.opts.connectionRetries = this.opts.connectionRetries || DEFAULT_CONNECTIONS_RETRIES

    console.log('this.opts2', this.opts)
